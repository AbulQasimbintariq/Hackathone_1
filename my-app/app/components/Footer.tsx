  ...
  return (
    <footer className="bg-gray-100 text-gray-800">
      ...
      <div className="bg-black text-white text-center py-8 px-4">
        ...
        <form className="flex flex-wrap justify-center items-center gap-1 max-w-lg mx-auto">
          <input
            type="email"
          ...
          <button
            type="submit"
            className="bg-white text-black px-6 py-2 rounded-r-md font-medium hover:bg-gray-2"
          >
